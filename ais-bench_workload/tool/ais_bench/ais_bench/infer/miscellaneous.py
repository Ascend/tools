...
def version_check(args):
    ...
    if aclruntime_version is None or aclruntime_version == "0.0.1":
        ...
        logger.warning("1. visit https://github.com/Ascend/tools/tree/master/ais-bench_workload/tool/ais_bench to install")
        logger.warning("2. or run cmd: pip3  install -v --force-reinstall 'git+https://github.com/Ascend/tools.git#egg=aclruntime&subdirectory=ais-bench_workload/tool/ais_bench/backend' to install")
