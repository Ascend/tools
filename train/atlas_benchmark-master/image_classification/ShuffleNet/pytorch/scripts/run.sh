...
train_job_dir=${currentDir%train*}/train/result/pt_shufflenet/training_job_${currtime}/
...
if [ x"${CLUSTER}" == x"True" ];then
    # ln hw log
    ln -snf ${train_job_dir}/0/hw_shufflenet.log ${train_job_dir}
    ...
    # ln hw log
    ln -snf ${train_job_dir}/${first_device_id}/hw_shufflenet.log ${train_job_dir}
