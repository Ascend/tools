...
```
Details of dnmetis_backend installation can be found in backend_C++/dnmetis_backend/Readme_cn.md. Notice that, you just need to install requirements once for a brand new Ai1-Inference environment。
