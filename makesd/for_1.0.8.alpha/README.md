...
- 固件与驱动包：A200dk-npu-driver-20.1.0-ubuntu18.04-aarch64-minirc.tar.gz，[点击跳转](https://ascend.huawei.com/#/hardware/firmware-drivers)

- 加速模块包：Ascend-cann-minirc_20.1.rc1_ubuntu18.04-aarch64.zip，[点击跳转](https://ascend.huawei.com/#/software/cann/community)
...
1. 如下图下载制卡需要的软件包  
    ...
    - 下载加速模块包。   
        下载地址：**https://ascend.huawei.com/#/software/cann/community**（历史版本中的3.1.0.alpha001版本）    
        ![](https://images.gitee.com/uploads/images/2021/0317/151241_ab6dda78_5400693.png "3be1dd9611693ba5d137a88386c9991.png")   
2. 下载制卡脚本和ubuntu18.04-arm.iso。  
	...
	**cd $HOME/tools/makesd/for_1.0.8.alpha/**  
	...
	HwHiAiUser@ubuntu:~$ cd tools/makesd/for_1.0.8.alpha/
	HwHiAiUser@ubuntu:~/tools/makesd/for_1.0.8.alpha$ ls
...
3. 将之前下载的制卡所需包放置到该目录（普通用户的 $HOME/tools/makesd/for_1.0.8.alpha）下。  
	```powershell  
