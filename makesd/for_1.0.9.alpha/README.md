...
制卡需要固件与驱动包和社区版cann_nnrt包，分别有对应的硬件版本号和CANN版本号。下表为硬件版本与CANN版本配套表，请根据硬件版本选择对应的CANN版本包进行制卡。
...
1. 如下图下载制卡需要的软件包  
    ...
    - 下载加速模块包。    
        下载地址：**https://ascend.huawei.com/#/software/cann/community**  （**历史版本中的3.2.0.alpha001/3.3.0.alpha001,以3.2.0举例**）      
